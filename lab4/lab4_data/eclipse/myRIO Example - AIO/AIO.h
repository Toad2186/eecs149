...
typedef struct
{
    ...
    uint32_t wght;          /**< AIO weight register */
    uint32_t ofst;          /**< AIO offset value register */
    uint32_t set;           /**< AO set register, unused for AI */
    NiFpga_Bool is_signed;  /**< Is the AIO signed */
    double scale_weight;    /**< AIO weight value */
    double scale_offset;    /**< AIO offset value */
} MyRio_Aio;
...
typedef struct
{
    ...
    uint32_t ai_scale_rdy;  /**< Analog input scale ready register */
    uint32_t ao_scale_rdy;  /**< Analog output scale ready register */
} MyRio_Aio_Rdy;
